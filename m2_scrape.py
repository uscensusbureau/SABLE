...
def scrape_data_CT(lines_clean, state, yyyy, mm):
    ...
    tax_types_list = []
    tax_types_list.append({"tax_type": "withholding",                               "tax_regex": ""})
    tax_types_list.append({"tax_type": "estimates and finals",                      "tax_regex": ""})
    tax_types_list.append({"tax_type": "sales and use",                             "tax_regex": ""})
    tax_types_list.append({"tax_type": "room occupancy",                            "tax_regex": ""})
    tax_types_list.append({"tax_type": "corporation business",                      "tax_regex": ""})
    tax_types_list.append({"tax_type": "pass-through entity",                       "tax_regex": ""})
    tax_types_list.append({"tax_type": "unrelated business income",                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "cable, satellite and video",                "tax_regex": ""})
    tax_types_list.append({"tax_type": "peg account",                               "tax_regex": ""})
    tax_types_list.append({"tax_type": "electric and power",                        "tax_regex": ""})
    tax_types_list.append({"tax_type": "gas companies",                             "tax_regex": ""})
    tax_types_list.append({"tax_type": "railroads",                                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "estate and gift",                           "tax_regex": ""})
    tax_types_list.append({"tax_type": "domestic",                                  "tax_regex": ""})
    tax_types_list.append({"tax_type": "foreign",                                   "tax_regex": ""})
    tax_types_list.append({"tax_type": "health care centers",                       "tax_regex": ""})
    tax_types_list.append({"tax_type": "nonadmitted unauthorized captive insurers", "tax_regex": ""})
    tax_types_list.append({"tax_type": "alcoholic beverages",                       "tax_regex": ""})
    tax_types_list.append({"tax_type": "cigarette",                                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "electronic cigarette products",             "tax_regex": ""})
    tax_types_list.append({"tax_type": "tobacco products",                          "tax_regex": ""})
    tax_types_list.append({"tax_type": "controlling interest transfer",             "tax_regex": ""})
    tax_types_list.append({"tax_type": "real estate conveyance",                    "tax_regex": ""})
    tax_types_list.append({"tax_type": "petroleum gross earnings",                  "tax_regex": ""})
    tax_types_list.append({"tax_type": "admission and dues and tnc fee",            "tax_regex": ""})
    tax_types_list.append({"tax_type": "dry cleaners",                              "tax_regex": ""})
    tax_types_list.append({"tax_type": "occupational",                              "tax_regex": ""})
    tax_types_list.append({"tax_type": "rental surcharge",                          "tax_regex": ""})
    tax_types_list.append({"tax_type": "solid waste",                               "tax_regex": ""})
    tax_types_list.append({"tax_type": "tourism tax",                               "tax_regex": ""})
    tax_types_list.append({"tax_type": "controlled substances",                     "tax_regex": ""})
    tax_types_list.append({"tax_type": "prepaid wireless e911 fee",                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "cannabis tax",                              "tax_regex": ""})
    tax_types_list.append({"tax_type": "paid preparer fee",                         "tax_regex": ""})
    tax_types_list.append({"tax_type": "repealed taxes",                            "tax_regex": ""})
    tax_types_list.append({"tax_type": "nursing home user fee",                     "tax_regex": ""})
    tax_types_list.append({"tax_type": "hospitals",                                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "intermediate care facility",                "tax_regex": ""})
    tax_types_list.append({"tax_type": "ambulatory surgical center",                "tax_regex": ""})
    tax_types_list.append({"tax_type": "gasoline",                                  "tax_regex": ""})
    tax_types_list.append({"tax_type": "special fuel",                              "tax_regex": ""})
    tax_types_list.append({"tax_type": "motor carrier",                             "tax_regex": ""})
    tax_types_list.append({"tax_type": "highway use fee",                           "tax_regex": ""})
    tax_types_list.append({"tax_type": "total motor fuel taxes",                    "tax_regex": ""})
    tax_types_list.append({"tax_type": "total healthcare taxes",                    "tax_regex": ""})
    tax_types_list.append({"tax_type": "total miscellaneous taxes",                 "tax_regex": ""})
    tax_types_list.append({"tax_type": "total cigarette taxes",                     "tax_regex": ""})
    tax_types_list.append({"tax_type": "total income taxes",                        "tax_regex": ""})
    tax_types_list.append({"tax_type": "total sales & use tax",                     "tax_regex": ""})
    tax_types_list.append({"tax_type": "total corporation taxes",                   "tax_regex": ""})
    tax_types_list.append({"tax_type": "total public service corps.",               "tax_regex": ""})
    tax_types_list.append({"tax_type": "total insurance taxes",                     "tax_regex": ""})
    tax_types_list.append({"tax_type": "licenses",                                  "tax_regex": ""})
    tax_types_list.append({"tax_type": "beverage container deposit",                "tax_regex": ""})
    tax_types_list.append({"tax_type": "total healthcare fees",                     "tax_regex": ""})
